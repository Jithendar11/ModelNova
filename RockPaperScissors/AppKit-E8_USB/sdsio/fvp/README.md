...
The Arm Virtual Hardware is configured for **Corstone-320** with the [fvp_config.txt](https://github.com/ARM-software/SDS-Framework/blob/main/template/Board/Corstone-320/fvp_config.txt).
...
- select the active target `SSE-320-U85`, build and run the application.
